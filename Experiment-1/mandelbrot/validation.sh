...
analyze_complexity "${BENCH_DIR}/mandelbrot.cpp" "C++"
analyze_complexity "${BENCH_DIR}/mandelbrot.py" "Python"
analyze_complexity "${BENCH_DIR}/mandelbrot.py" "Codon"
...
do
    ...
    CPP_OUTPUT=$("${BENCH_DIR}/mandelbrot_cpp" ${SIZE})
    echo "$CPP_OUTPUT"
